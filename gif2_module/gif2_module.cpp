...
/*
 * There are three scenarios, in which gif2_Module can be loaded by NEST:
 *
...
mynest::gif2_Module gif2_module_LTX_mod;
#endif
// -- DynModule functions ------------------------------------------------------

mynest::gif2_Module::gif2_Module()
{
#ifdef LINKED_MODULE
...
const std::string
mynest::gif2_Module::name( void ) const
{
  return std::string( "GIF2 NEST Module" ); // Return name of the module
}

const std::string
mynest::gif2_Module::commandstring( void ) const
{
  // Instruct the interpreter to load gif2_module-init.sli
  return std::string( "(gif2_module-init) run" );
}

//-------------------------------------------------------------------------------------

void
mynest::gif2_Module::init( SLIInterpreter* i )
{
  /* Register a neuron or device model.
     Give node type as template argument and the name as second argument.
  */
  nest::kernel().model_manager.register_node_model< nest::gif2_psc_exp >(
    "gif2_psc_exp" );
