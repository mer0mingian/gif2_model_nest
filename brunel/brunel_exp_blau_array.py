...
def run_specific_network(somevec):
    ...
    J = np.array([ [ J_ex, h * J_ex, J_ex ], [ J_ex, h * J_ex, J_ex ],
                   [ -g * J_ex, -g * J_ex, -g * J_ex ] ])
    C = np.array([ [ 0.083, 0.083, 0.06 ], [ 0.083, 0.083, 0.06 ],
                   [ 0.373, 0.373, 0.316 ] ])
    C[ 0, : ] *= NE
    C[ 1, : ] *= NR
    C[ 2, : ] *= NI
...
if __name__ == '__main__':
    ...
    try:
        ...
        pass
    nest.SetStatus({"local_num_threads": 8})
