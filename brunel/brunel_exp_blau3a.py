...
h = 1.9  # 1.625  # ratio resonating weight/excitatory weight
J_re = h * J
...
nest.SetStatus(multi, params={"interval": dt,
                        "record_from": [ "V_m", "w" ],
                        "withgid": True} )
...
nest.SetStatus(noise2, [ {"rate": p_rate2,
                          "amplitude":     0.025 * p_rate,
                          "frequency":     10.0 } ])
