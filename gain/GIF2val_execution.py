...
# try: from GIF2val_functions_blau import *
# except: print('importing my functions did not work!')
...
for condition in noise_conditions:
    ...
    # contains N, nbins, current/poisson, t_sim, t_rec, t_recstart, simindex, synweight
    ...
    gain, exp_r_0 = compute_gain(hist_bins, hist_heights, hist_binwidth, I_1, f)
